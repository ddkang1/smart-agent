...
class TestSmartAgent:
    ...
    @patch("smart_agent.agent.AsyncOpenAI")
    @patch("smart_agent.agent.get_tool_client")
    async def test_agent_chat_completion(self, mock_get_tool_client, mock_openai, mock_config):
    ...
    @patch("smart_agent.agent.AsyncOpenAI")
    @patch("smart_agent.agent.get_tool_client")
    async def test_agent_tool_call(self, mock_get_tool_client, mock_openai, mock_config):
